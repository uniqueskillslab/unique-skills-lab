...
const Footer = () => {
    ...
    try {
      ...
      const response = await fetch('https://formspree.io/f/xovnprzr', {
        ...
        body: JSON.stringify({
          ...
          _subject: 'New Contact Form Submission - Unique Skills Lab'
        })
      })
  ...
  const socialLinks = [
    ...
    {
      name: 'TikTok',
      url: 'https://www.tiktok.com/@uniqueskilslab',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Makkah Town Multan Road, Phoolnagar</p>
                </div>
              </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {submitStatus === 'error' && (
                <p className="text-red-400 text-sm">Please fill in all required fields (Name, Email, Phone, Message).</p>
              )}
            </form>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            © 2025 Unique Skills Lab. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
